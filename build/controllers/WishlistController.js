...
let WishlistController = class WishlistController {
    ...
    addProductToWishlist(id, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const itemId = yield this.wishlistService.addToWishlist(id);
    ...
    getWishlistItems(response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const items = yield this.wishlistService.getWishlistItems();
                return response.status(200).send({
                    status: "success",
                    data: items,
                });
...
exports.WishlistController = WishlistController = __decorate([
    (0, typedi_1.Service)(),
    (0, routing_controllers_1.JsonController)('/wishlist')
], WishlistController);
